...
img_path = os.path.join(_DIR, 'sprites base dos personagens', 'Donquixote Doflamingo.png')
...
out_dir = os.path.join(_DIR, 'frames doflamingo')
...
for i, (contour, bbox) in enumerate(contours_ordenados):
    ...
    if w > 10 and h > 10:
        ...
        caminho_frame = os.path.join(out_dir, f'doflamingo_{i}.png')

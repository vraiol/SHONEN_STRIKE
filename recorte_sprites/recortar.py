...
img_path = os.path.join(_DIR, 'sprites base dos personagens', 'aizen.png')
...
out_dir = os.path.join(_DIR, 'frames aizen1')
...
for i, (contour, bbox) in enumerate(contours_ordenados):
    ...
    if w > 10 and h > 10:
        ...
        caminho_frame = os.path.join(out_dir, f'aizen_frame_{i}.png')

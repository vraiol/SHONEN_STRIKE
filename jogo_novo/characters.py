...
_SPRITES_DIR = os.path.join(_DIR, "sprites")  # sprites/ dentro de jogo_novo/
...
CHARACTERS = [
    {
        ...
        "anim_folder": os.path.join(_SPRITES_DIR, "ichigo"),
        "colorkey": (0, 128, 0),
        "sprite_scale": 1.5,
    ...
    },
    {
        ...
        "anim_folder": os.path.join(_SPRITES_DIR, "luffy"),
        "sprite_scale": 1.8,
    ...
    },
    {
        ...
        "anim_folder": os.path.join(_SPRITES_DIR, "naruto"),
        "colorkey": (0, 64, 128),  
        "sprite_scale": 1.8,
    ...
    },
    {
        ...
        "anim_folder": os.path.join(_SPRITES_DIR, "sasuke"),
    ...
    },
    {
        ...
        "anim_folder": os.path.join(_SPRITES_DIR, "roronoa zoro"),
    ...
    },
    {
        ...
        "anim_folder": os.path.join(_SPRITES_DIR, "kenpachi zaraki"),
...
ENEMIES = [
    {   # Fase 1 — inimigo mais fraco
        ...
        "anim_folder": os.path.join(_SPRITES_DIR, "aizen"),
    ...
    {   # Fase 2 — intermediário
        ...
        "anim_folder": os.path.join(_SPRITES_DIR, "pain"),
    ...
    {   # Fase 3 — chefe final
        ...
        "anim_folder": os.path.join(_SPRITES_DIR, "donquixote doflamingo"),

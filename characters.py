...
CHARACTERS = [
    {
        ...
        "anim_folder": os.path.join(os.path.dirname(_DIR), "assets", "characters", "ichigo"),
        "colorkey": (0, 128, 0),
        "sprite_scale": 1.6,
    ...
    },
    {
        ...
        "anim_folder": os.path.join(os.path.dirname(_DIR), "assets", "characters", "monkey d luffy"),
        "sprite_scale": 1.5,
    ...
    },
    {
        ...
        "anim_folder": os.path.join(os.path.dirname(_DIR), "assets", "characters", "naruto"),
        "colorkey": (0, 64, 128),  
        "sprite_scale": 1.5,
    ...
    },
    {
        ...
        "anim_folder": os.path.join(os.path.dirname(_DIR), "assets", "characters", "sasuke"),
    ...
    },
    {
        ...
        "anim_folder": os.path.join(os.path.dirname(_DIR), "assets", "characters", "roronoa zoro"),
    ...
    },
    {
        ...
        "anim_folder": os.path.join(os.path.dirname(_DIR), "assets", "characters", "zaraki"),
...
ENEMIES = [
    {   # Fase 1 — inimigo mais fraco
        ...
        "anim_folder": os.path.join(os.path.dirname(_DIR), "assets", "characters", "aizen"),
    ...
    {   # Fase 2 — intermediário
        ...
        "anim_folder": os.path.join(os.path.dirname(_DIR), "assets", "characters", "pain"),
    ...
    {   # Fase 3 — chefe final
        ...
        "anim_folder": os.path.join(os.path.dirname(_DIR), "assets", "characters", "doflamingo"),
